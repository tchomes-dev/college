...
public class Fractal {
  ...
  private void drawTree(Point2D p1, Point2D p2, int level) {
    ...
    t2.turnRight(15);
    t2.move(2 * distance);
    Point2D p5 = new Point2D.Double(t2.getPosition().getX(), t2.getPosition().getY());
  ...
  private void drawSierpinskiTriangle(Point2D p1, Point2D p2, Point2D p3, int level) {
    ...
    Point2D p6 = new Point2D.Double(((p3.getX() + p1.getX()) / 2), ((p3.getY() + p1.getY()) / 2));
  ...
  private void drawSierpinskiCarpet(Point2D p, double a, int level) {
    ...
    // TODO
    Point2D p1 = new Point2D.Double(p.getX(), p.getY());
    drawSierpinskiCarpet(p1, a / 3, level - 1);
    Point2D p2 = new Point2D.Double(p.getX() + (a / 3), p.getY());
    drawSierpinskiCarpet(p2, a / 3, level - 1);
    Point2D p3 = new Point2D.Double((p.getX() + (a / 3) * 2), p.getY());
    ...
    Point2D p7 = new Point2D.Double(p.getX(), p.getY() + ((a / 3) * 2));
    ...
    Point2D p9 = new Point2D.Double(p.getX() + ((a / 3) * 2), p.getY() + ((a / 3) * 2));
    drawSierpinskiCarpet(p9, a / 3, level - 1);
  }
