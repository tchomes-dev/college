...
public abstract class AbstractArrayHeap<P, V> {
  ...
  /**
   * Adds the specified {@code value} to this {@link AbstractArrayHeap} with the
   * specified {@code priority}. For convenience, returns the modified
   * {@link AbstractArrayHeap}.
   * 
   * @param priority the priority for this entry
   * @param value    the value for this entry
   * @return The modified {@link AbstractArrayHeap}
   * @throws NullPointerException if {@code priority} or {@code value} are
   *                              {@code null}.
   */
   ...
   * {@link AbstractArrayHeap}. For convenience, this method returns the removed
   * value.
   * 
  ...
  /**
   * Returns {@code true} if this {@link AbstractArrayHeap} has no elements in it
   * and {@code false} otherwise.
   * 
   * @return {@code true} if this {@link AbstractArrayHeap} has no elements in it
   *         and {@code false} otherwise.
   */
  ...
  /**
   * <p> This results in the entry at the specified index "bubbling up" to a
   * location such that the property of the heap are maintained. This method
   * should run in O(log(size)) time. </p> <p> Note: When add is called, an Entry
   * is placed at the end of the internal array and then this method is called on
   * that index. </p>
   * 
  ...
  /**
   * <p> This method results in the entry at the specified index "bubbling down"
   * to a location such that the property of the heap are maintained. This method
   * should run in O(log(size)) time. </p> <p> Note: When remove is called, if
   * there are elements remaining in this {@link AbstractArrayHeap} the bottom
   * most element of the heap is placed at the 0th index and bubbleDown(0) is
   * called. </p>
   * 
   * @param index : index i
   */
