...
public class PublicArrayHeapTest {
  ...
  public void testBubbleUp() {
    ...
    /*
     * Original State Initial Add After BubbleUp (".", 1) => (".", 1) => ("..", 2) /
     * / ("..", 2) (".", 1)
     */
    ...
    /*
     * Original State Initial Add After BubbleUp ("..", 2) => ("..", 2) => ("...",
     * 3) / / \ / \ (".", 1) (".", 1) ("...", 3) (".", 1) ("..", 2)
     */
    ...
    /*
     * Original State Initial Add After BubbleUp ("...", 3) => ("...", 3) =>
     * (".....", 4) / \ / \ / \ (".", 1) ("..", 2) (".", 1) ("..", 2) ("...", 3)
     * ("..", 2) / / (".....", 4) (".", 1)
     */
    ...
    /*
     * Original State => Initial Add => After BubbleUp (".....", 4) (".....", 4)
     * (".....", 4) / \ / \ / \ ("...", 3) ("..", 2) ("...", 3) ("..", 2) ("....",
     * 5) ("..", 2) / / \ / \ (".", 1) (".", 1) ("....", 5) (".", 1) ("...", 3)
     */
  ...
  public void testBubbleUpAndBubbleDown() {
    ...
    /*
     * Starting State => Initial removal => After Bubble Down (".....", 4) ("...",
     * 3) ("....", 5) / \ / \ / \ ("....", 5) ("..", 2) ("....", 5) ("..", 2)
     * ("...", 3) ("..", 2) / \ / / (".", 1) ("...", 3) (".", 1) (".", 1)
     */
    ...
    /*
     * Starting State => Initial removal => After Bubble Down ("....", 5) (".", 1)
     * ("...", 3) / \ / \ / \ ("...", 3) ("..", 2) ("...", 3) ("..", 2) (".", 1)
     * ("..", 2) / (".", 1)
     */
    ...
    /*
     * Starting State => Initial removal => After Bubble Down ("...", 3) ("..", 2)
     * ("..", 2) / \ / / (".", 1) ("..", 2) (".", 1) (".", 1)
     * 
     */
    ...
    /*
     * After Bubble Down => Initial removal => After Bubble Down ("..", 2) (".", 1)
     * (".", 1) / (".", 1)
     * 
     */
